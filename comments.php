...
<div id="comments" class="clearfix">
                        ...
                        <div class="comment-meta">
                            ...
                            <div class="comment-author vcard">
                                ...
                                <span class="comment-avatar clearfix">
                                    <?php echo get_avatar($comment, 60, '', '', ['class' => 'avatar avatar-60 photo avatar-defaul']) ?>
                                </span>
    ...
    <div id="respond" class="clearfix">
        <?php comment_form([
            ...
            'label_submit'      =>  __('Submit Comment', 'Test'),
            'title_reply'       =>  __('Leave a <span>Comment</span>', 'test')
        ]); ?>
