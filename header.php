                    ...
                    <div class="top-links">
                        ...
                        if (has_nav_menu('secondary')) {
                            wp_nav_menu([
                                ...
                                'fallback_cb'         =>  false,
                                'depth'               =>  1,
                                // 'walker'              =>  new JU_Customer_Nav_Walker()
                            ]);
                        }
                        ?>
                    </div><!-- .top-links end -->
            ...
            <div class="container clearfix">
                ...
                <div class="top-advert">
                    ...
                    if (function_exists('quads_ad')) {
                        echo quads_ad(['location' => 'test_header']);
                    }
                    ?>
                </div>
                        ...
                        ============================================= -->
                            <div id="top-search">
                                ...
                                <form action="<?php echo esc_url(home_url('/')); ?>" method="get">
                                    <input type="text" name="q" class="form-control" placeholder="<?php _e('Type &amp; Hit Enter..', 'test'); ?>" value="<?php the_search_query(); ?>">
                                </form>
                            </div><!-- #top-search end -->
